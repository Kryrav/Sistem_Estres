<?php 
    ...
    class Usuarios extends Controllers{
        ...
        public function Usuarios()
        {
            ...
            $data['page_title'] = "USUARIOS <small>Sistema</small>";
            ...
            if($_POST){      
                if(empty($_POST['txtIdentificacion']) || empty($_POST['txtNombre']) || empty($_POST['txtApellido']) || empty($_POST['txtTelefono']) || empty($_POST['txtEmail']) || empty($_POST['listRolid']) || empty($_POST['listStatus']) )
                {
                    ...
                    if($idUsuario == 0)
                    {
                        ...
                        // USAR password_hash() para cifrado seguro en lugar de SHA256
                        ...
                        if($_SESSION['permisosMod']['w']){
                            $request_user = $this->model->insertUsuario($strIdentificacion,
                                                                        ...
                                                                        $intTelefono, 
                                                                        $strEmail,
                                                                        $strPassword, // Ya es un hash seguro
                                                                        $intTipoId, 
                                                                        $intStatus );
                        }
                    }else{
                        ...
                        // Si se proporciona una contraseña, hashearla de forma segura. Si está vacío, se envía ""
                        $strPassword = empty($_POST['txtPassword']) ? "" : password_hash($_POST['txtPassword'], PASSWORD_DEFAULT);
                        ...
                        if($_SESSION['permisosMod']['u']){
                            $request_user = $this->model->updateUsuario($idUsuario,
                                                                        ...
                                                                        $intTelefono, 
                                                                        $strEmail,
                                                                        $strPassword, // Contiene hash seguro o ""
                                                                        $intTipoId, 
                                                                        $intStatus);
                        }
